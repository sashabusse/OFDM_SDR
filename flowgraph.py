...
class flowgraph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32('ip:192.168.3.1' if 'ip:192.168.3.1' else iio.get_pluto_uri(), [True, True], ((64+16)*2 + 200)*100)
        ...
        self.blocks_vector_to_stream_1 = blocks.vector_to_stream(gr.sizeof_gr_complex*1, ((64+16)*2 + 200))
        ...
        self.OFDM_OOT_ofdm_source_0 = OFDM_OOT.ofdm_source()
        ...
        self.connect((self.OFDM_OOT_autocorr_cpp_cc_0, 0), (self.blocks_null_sink_1, 0))
        self.connect((self.OFDM_OOT_autocorr_cpp_cc_0, 1), (self.blocks_null_sink_1, 1))
        ...
        self.connect((self.OFDM_OOT_ofdm_preamble_sync_0, 0), (self.blocks_complex_to_arg_0, 0))
        self.connect((self.OFDM_OOT_ofdm_preamble_sync_0, 0), (self.blocks_complex_to_mag_1_0_0, 0))
        self.connect((self.OFDM_OOT_ofdm_source_0, 0), (self.blocks_vector_to_stream_1, 0))
        ...
        self.connect((self.iio_pluto_source_0, 0), (self.OFDM_OOT_autocorr_cpp_cc_0, 0))

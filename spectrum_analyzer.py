...
# Title: spectrum analyzation and testing
# Author: sashabusse
# Copyright: @sashabusse
...
class spectrum_analyzer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "spectrum analyzation and testing", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("spectrum analyzation and testing")

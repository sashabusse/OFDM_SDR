...
autocorr_cpp_cccc::sptr autocorr_cpp_cccc::make(int sz, int dn, bool normalize)
{
    return gnuradio::make_block_sptr<autocorr_cpp_cccc_impl>(sz, dn, normalize);
}


autocorr_cpp_cccc_impl::autocorr_cpp_cccc_impl(int sz, int dn, bool normalize)

...
# from gnuradio import blocks
try:
  from gnuradio.OFDM_OOT import ofdm_modulator_cpp_cc
except ImportError:
    import os
    import sys
...
class qa_ofdm_modulator_cpp_cc(gr_unittest.TestCase):
    ...
    def test_instance(self):
        instance = ofdm_modulator_cpp_cc(1024, [2, 4, 6], [1, 3, 5, 7], [1.2]*4, 128)
    ...
    def test_001_just_run_without_falling(self):
        ...
        mod = ofdm_modulator_cpp_cc(nfft, data_idx, pilot_idx, pilot_val, n_guard)
        ...
        self.assertFloatTuplesAlmostEqual(list(exp_res)[n_guard:], dst.data()[n_guard:], 6)


if __name__ == '__main__':
    gr_unittest.run(qa_ofdm_modulator_cpp_cc)

...
#include "cfar_detector_cpp_impl.h"
...
cfar_detector_cpp::sptr cfar_detector_cpp::make(gr_vector_int train_regions,
                                                float p_false_alarm,
                                                int n_search_forward,
                                                int n_skip_after_detect)
{
    return gnuradio::make_block_sptr<cfar_detector_cpp_impl>(
 ...
 */
cfar_detector_cpp_impl::cfar_detector_cpp_impl(gr_vector_int train_regions,
                                               float p_false_alarm,
                                               int n_search_forward,
                                               int n_skip_after_detect)
    : gr::block("cfar_detector_cpp",
 ...
 */
cfar_detector_cpp_impl::~cfar_detector_cpp_impl() {}

void cfar_detector_cpp_impl::forecast(int noutput_items,
...
int cfar_detector_cpp_impl::general_work(int noutput_items,
...
void cfar_detector_cpp_impl::process_next(const gr_complex* in_corr, int tg_idx)
{
    // add new taps
